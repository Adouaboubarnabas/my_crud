...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1651748095ltr&server=1">
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="405d7c22302b3b317a6b43643d284126">
...
</span><small>Définir à 0 pour replier le panneau de navigation.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="0"><a class="restore-default hide" href="#NavigationWidth" title="Restaurer la valeur par défaut"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Faire Entrée pour exécuter la requête                    </span>
                            ...
                            targetdb="mydatabase" targettable="members">
            ...
            Daté du
                            ...
                            <span class="query">CREATE TABLE `mydatabase`.`members` ( `id` INT NOT NULL ,  `nom` VARCHAR(120) NOT NULL ,  `prenom` VARCHAR(120) NOT NULL ,  `date_naissance` DATE NOT NULL ,  `adresse_habitation` VARCHAR(120) NOT NULL ,  `produit` VARCHAR(120) NOT NULL ,  `montant_souscription` INT NOT NULL ,  `montant_garantie` INT NOT NULL ) ENGINE = InnoDB;</span>
                        </div>
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `members`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="mydatabase" targettable="members">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">DELETE FROM `members` WHERE `members`.`id` = 3</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="mydatabase" targettable="members">
                            <div class="action_content">
